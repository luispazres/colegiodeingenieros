...
class vistaComentariosAprobacion
{
                  ...
                  <div class='x_title'>
                    ...
                    <div class='x_content'>
                      <br>
                        ...
                        <form method='post' action='index.php?page=revisarSolicitudAprobacionCimeqh' id='defaultForm' name'defaultForm' data-parsley-validate class='form-horizontal form-label-left'>
