            ...
            <tbody>
              {{foreach solicitud}}
                <tr>
                  ...
                  <td> <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg-{{estadoFactibilidadId}}">Opciones</button>

                    <div class="modal fade bs-example-modal-lg-{{estadoFactibilidadId}}" tabindex="-1" role="dialog" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                              ...
                              <a href="index.php?page=comentarios&solicitudFactibilidadId={{solicitudFactibilidadId}}"><input type="button" name="btnRechazar" id="btnRechazar" class="btn btn-danger" value="Rechazar Factibilidad">
