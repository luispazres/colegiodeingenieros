                  ...
                  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                      ...
                      <ul class="nav side-menu">
                        ...
                        <li><a href="index.php?page=revisarSolicitudAprobacionCimeqh"><i class="fa fa-check"></i>Revisar Solicitudes de Aprobación de Proyectos<span class="fa fa-chevron-down"></span></a>
                        </li>
