            ...
            <tbody>
              {{foreach solicitud}}
                <tr>
                  ...
                  <td> <button id="btnOpciones12" type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg-{{solicitudRecepcioId}}" value="{{solicitudAprobacionId}}">Opciones</button>
