                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                              ...
                              <a href="index.php?page=comentarios&tipo=rechazo&accion=factibilidadEnee&codigo={{solicitudFactibilidadId}}"><input type="button" name="btnRechazar" id="btnRechazar" class="btn btn-danger" value="Rechazar Factibilidad">
                                <a href="index.php?page=comentarios&tipo=aceptado&accion=factibilidadEnee&codigo={{solicitudFactibilidadId}}"><input type="button" name="btnAceptar" id="btnAceptar" class="btn btn-success" value="Aceptar Factibilidad">
                              </form>
                          </div>
                        </div>
                      </div>
